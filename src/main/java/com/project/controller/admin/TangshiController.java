...
public class TangshiController extends BaseController {
	...
	public void index() throws Exception {
		...
		String sWhere = " from db_orders o left join db_tables t on o.tables_id=t.id left join db_shop s on o.shop_id=s.id left join db_business b on o.business_id=b.id left join db_user u on o.user_id=u.id where o.display=? and o.takeaway=? and o.appointment=? and b.status!=?";

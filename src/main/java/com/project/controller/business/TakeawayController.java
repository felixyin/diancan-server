...
public class TakeawayController extends BaseController {
	...
	public void index() throws Exception {
		...
		String sSelect = "select o.*, u.name user_name, u.img_url user_img_url, s.title shop_title";
		String sWhere = " from db_orders o left join db_user u on o.user_id=u.id left join db_shop s on o.shop_id=s.id where o.display=? and o.takeaway=? and o.business_id=?";
		...
		if (StrKit.notBlank(getPara("content"))) {
			sWhere += " and (o.code like ? or o.take_name like ? or o.take_mobile like ?)";
